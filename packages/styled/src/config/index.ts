...
export const getThemeInstance = (ThemeService: EventBusOptions) => ({
    ...
    getCustomPreset(name = '', preset: any, selector: string, params: any) {
        const options = { name, theme: this.theme, preset, options: this.options, selector, params, defaults: this.defaults, tokens: this.tokens, set: { layerNames: this.setLayerNames.bind(this) } };
